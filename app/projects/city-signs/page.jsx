...
const projectData = {
  ...
  subtitle: "Web-Based Road & City Sign Management System",
  description:
    "City Signs Management is a platform developed for a city council to manage, maintain, and track road and city signs. The system integrates maps for location visualization and streamlines maintenance workflows for improved urban infrastructure management.",
  longDescription:
    "This system allows the City Council to efficiently track the lifecycle of road and city signs, including creation, inspections, repairs, and retirement. It integrates interactive maps to visualize sign locations across the city, providing administrators and maintenance teams with real-time updates. The lightweight architecture ensures smooth operation while being cost-effective to deploy and scale. Designed as a complete full-stack solution, it combines modern frameworks with reliable backend technologies to deliver a production-ready municipal tool.",
  images: Array.from(
    { length: 9 },
    (_, i) => `/images/projects/city-signs/${i + 1}.png`
  ),
  techStack: ["Next.js", "Inertia.js", "Laravel", "SQLite", "Leaflet.js"],
  role: "Full-Stack Developer (Frontend, Backend, DevOps)",
  responsibilities: [
    "Designed and implemented a responsive frontend with Next.js",
    "Developed backend APIs and sign lifecycle management with Laravel & Inertia.js",
    "Integrated Leaflet.js for interactive sign location visualization on maps",
    "Optimized SQLite database for lightweight but reliable city-scale storage",
    "Handled deployment, server setup, and CI/CD pipeline configuration",
  ],
  duration: "4 months",
  teamSize: "1 developer",
  status: "Completed",
  features: [
    "Interactive map integration for sign location management",
    "Full lifecycle tracking: creation, maintenance, and retirement",
    "Maintenance scheduling and issue logging",
    "Maintenance task assignment to city council repair personnel",
    "Responsive UI for desktop and mobile access",
    "Lightweight architecture suitable for municipal budgets",
  ],
  challenges: [
    "Integrating a smooth and responsive mapping system with Leaflet.js",
    "Balancing lightweight performance with reliability for city-scale data",
    "Designing a user-friendly interface for non-technical council staff",
  ],
  outcomes: [
    "Reduced maintenance response time by 40% through streamlined workflows",
    "Provided city staff with real-time visibility of infrastructure status",
    "Delivered a cost-effective, production-ready system for municipal use",
  ],
  liveUrl: "",
  githubUrl: "https://github.com/T-Huwa/citysigns",
