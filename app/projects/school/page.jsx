...
const projectData = {
  title: "IGFT",
  subtitle: "Integrated Academic & Administrative Platform",
  description:
    "A comprehensive system for secondary schools to manage student grades, fee payments, and disciplinary records, with built-in statistics and reporting tools.",
  longDescription:
    "The Secondary School Management System streamlines school operations by integrating academic, financial, and disciplinary management into one platform. Teachers can record grades, track student performance, and generate academic reports. Administrators can monitor fee payments, issue reminders, and generate financial summaries. Disciplinary incidents are logged and analyzed for trends. Built with FastAPI, Next.js, and PostgreSQL, the platform ensures scalability, performance, and an intuitive user experience for staff and administrators.",
  images: Array.from(
    { length: 6 },
    (_, i) => `/images/projects/school/${i + 1}.png`
  ),
  techStack: ["FastAPI", "Next.js", "Tailwind CSS", "PostgreSQL"],
  role: "Full-Stack Developer",
  responsibilities: [
    "Designed and developed RESTful APIs with FastAPI",
    "Built a responsive Next.js frontend with Tailwind CSS",
    "Implemented PostgreSQL schema for student records, finances, and discipline",
    "Integrated reporting and statistics dashboards for administrators",
    "Ensured secure handling of student and financial data",
    "Automatic report card generation for grades",
    "Automatic mass notifications of fees balances, term start and end of term progrss reports on SMS and WhatsApp",
  ],
  duration: "5 months",
  teamSize: "1 developer",
  status: "Completed",
  features: [
    "Student grade recording and academic performance tracking",
    "Fee payment management with reminders and reports",
    "Disciplinary incident logging and trend analysis",
    "Customizable statistics dashboards",
    "Secure role-based access for teachers and administrators",
  ],
  challenges: [
    "Ensuring data accuracy across academics, finance, and disciplinary modules",
    "Building a scalable backend with real-time reporting",
    "Designing an intuitive interface for school administrators",
  ],
  outcomes: [
    "Improved transparency in academic and financial records",
    "Reduced administrative workload with automated reporting",
    "Delivered a unified system adaptable to multiple school environments",
  ],
  liveUrl: "",
  githubUrl: "",
