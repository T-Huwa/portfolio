...
const projectData = {
  title: "Ulimi Wamakono",
  subtitle: "Extension Worker Appointment management System",
  description:
    "Ulimi Wamakono is a web based platform that allows farmers in an area to interact with the extension worker of their area on various issues regarding animal and crop production, as well as managing appointments with them.",
  longDescription:
    "The platform smooth appointment management between farmers and extension workers, with follow up for each appointment. It also features a 7-day weather prediction with recommendations to inform farmers on farming decisions. Admins can areas and extension workers, while extension workers can manage their appointments and resources for farmers. Farmers can view these image and video resources that can be instructional on performing certain farming operations.",
  images: Array.from(
    { length: 10 },
    (_, i) => `/images/projects/ulimi/${i + 1}.png`
  ),
  techStack: ["React", "Bootstrap CSS", "Php", "MySql", "OpenWeather API"],
  role: "Full-Stack Developer",
  responsibilities: [
    "Designed and deployed Php Backend",
    "Designed and the deployed UI for all users",
    "Implemented role based access control for all routes and pages",
    "Built a responsive HTML5 frontend with Bootstrap CSS",
    "Integrated Openweather API to fetch weather forecast",
  ],
  duration: "4 months",
  teamSize: "1 developer",
  status: "Completed",
  features: [
    "Appointment booking and rescheduling for the farmer",
    "Appointment management for the extension worker: accepting, rescheduling, completing, cancelling",
    "Upload of text. image and video resources for farmer' benefit",
    "7-day forecast of weather in the farmer's area with recommendations",
    "Real-time communication between the farmer and the extension worker",
  ],
  challenges: [
    "Integrating with external weather APIs and inferring decisions from the forecast",
    "Managing role-based access securely between admins, extension workers and farmers",
  ...
  outcomes: [
    ...
    "Improved communication between farmers and extension workers",
  ],
  ...
  category: "Web Based Farmer platform",
};
