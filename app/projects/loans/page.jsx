...
const projectData = {
  title: "Group Loan System",
  subtitle: "Collaborative Loan Application & Tracking Platform",
  description:
    "A web-based system for managing group loans where members contribute different amounts but apply collectively as a group. It simplifies contribution tracking, loan disbursement, and repayment monitoring.",
  longDescription:
    "The Group Loan Management System enables microfinance institutions and community savings groups to organize and manage loans for groups of individuals. Each member can contribute different amounts, while the group applies as a whole for a loan. The administrators can then approve or deny each loan request, as well as track loan payments for each loan. The system tracks contributions, calculates eligibility, manages approvals, and monitors repayments. Built using lightweight and accessible technologies, it ensures ease of use in low-resource environments while maintaining robust functionality for financial management.",
  images: Array.from(
    { length: 7 },
    (_, i) => `/images/projects/loans/${i + 1}.png`
  ),
  techStack: ["PHP", "HTML5", "MySQL"],
  role: "Full-Stack Developer",
  responsibilities: [
    "Developed loan and contribution management modules in PHP",
    "Designed database schema in MySQL to handle group-based financial records",
    "Implemented a clean HTML/CSS interface for ease of use",
    "Created loan approval, disbursement, and repayment tracking workflows",
    "Ensured secure handling of member and loan data",
    "Integrated CTechPay for loan payments",
  ],
  duration: "2 months",
  teamSize: "1 developer",
  status: "Completed",
  features: [
    "Group-based loan application and management",
    "Individual contribution tracking within groups",
    "Loan eligibility and approval process",
    "Integrated payment gateway with Airtel Money",
    "Repayment scheduling and status tracking",
    "Simple and lightweight UI for low-resource environments",
  ],
  challenges: [
    "Designing logic to fairly calculate loan eligibility for groups with unequal contributions",
    "Ensuring system usability for users with minimal technical experience",
    "Maintaining data consistency and accuracy across loan cycles",
  ],
  outcomes: [
    "Enabled fair and transparent group loan management for community groups",
    "Improved record-keeping and reduced manual errors in loan tracking",
    "Delivered a lightweight, cost-effective system adaptable for microfinance institutions",
  ],
  liveUrl: "",
  githubUrl: "",
